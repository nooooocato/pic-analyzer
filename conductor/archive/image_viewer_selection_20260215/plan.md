...
- [x] Task: Implement Viewer pop-up and close animations. [e5f6g7h]
    - [x] Write Tests: Verify `QPropertyAnimation` is triggered on open/close.
    - [x] Implement: Use `QVariantAnimation` or `QPropertyAnimation` for smooth opacity/scale transitions.
- [x] Task: Conductor - User Manual Verification 'Phase 2: Image Viewer Overlay & Navigation' (Protocol in workflow.md)
